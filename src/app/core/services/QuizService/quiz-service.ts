...
export class ExamService {
  ...
  getExamsByCourse(courseId: string, pageNumber: number = 1, pageSize: number = 10): Observable<PagedResult<ExamDto>> {
    ...
    return this.http.get<PagedResult<ExamDto>>(
      `http://mahd3.runasp.net/api/exams/course/${courseId}`,
      { params }
    );
  }
  ...
  getExamById(id: string): Observable<ExamDto> {
    return this.http.get<ExamDto>(`http://mahd3.runasp.net/api/exams/${id}`);
  }
  ...
  createExam(data: CreateExamDto): Observable<ExamDto> {
    return this.http.post<ExamDto>(`http://mahd3.runasp.net/api/exams`, data);
  }
  ...
  updateExam(id: string, data: UpdateExamDto): Observable<ExamDto> {
    return this.http.put<ExamDto>(`http://mahd3.runasp.net/api/exams/${id}`, data);
  }
  ...
  deleteExam(id: string): Observable<any> {
    return this.http.delete(`http://mahd3.runasp.net/api/exams/${id}`);
  }
  ...
  getQuestionsByExamId(examId: string): Observable<ExamQuestionDto[]> {
    return this.http.get<ExamQuestionDto[]>(`http://mahd3.runasp.net/api/exam-questions/exam/${examId}`);
  }
  ...
  createQuestion(examId: string, data: CreateExamQuestionDto): Observable<ExamQuestionDto> {
    return this.http.post<ExamQuestionDto>(`http://mahd3.runasp.net/api/exam-questions/exam/${examId}`, data);
  }
  ...
  updateQuestion(questionId: string, data: UpdateExamQuestionDto): Observable<ExamQuestionDto> {
    return this.http.put<ExamQuestionDto>(`http://mahd3.runasp.net/api/exam-questions/${questionId}`, data);
  }
  ...
  deleteQuestion(questionId: string): Observable<any> {
    return this.http.delete(`http://mahd3.runasp.net/api/exam-questions/${questionId}`);
  }
  ...
  submitExamAttempt(examId: string, data: ExamAttemptSubmitDto): Observable<ExamAttemptDto> {
    return this.http.post<ExamAttemptDto>(`http://mahd3.runasp.net/api/exams/${examId}/submit`, data);
  }
  ...
  getExamAttempts(examId: string, pageNumber: number = 1, pageSize: number = 10): Observable<PagedResult<ExamAttemptDto>> {
    ...
    return this.http.get<PagedResult<ExamAttemptDto>>(
      `http://mahd3.runasp.net/api/exams/${examId}/attempts`,
      { params }
    );
  }
  ...
  getAttemptDetail(attemptId: string): Observable<any> {
    return this.http.get(`http://mahd3.runasp.net/api/exams/attempts/${attemptId}`);
  }
}
